...
import { CreateInterviewDTO, UpdateInterviewDTO } from "../dto/InterviewDTO";

class InterviewRepository {
  private model: typeof Interview;

  constructor(sequelize: Sequelize) {
    this.model = sequelize.models.Interview as typeof Interview;
  }
  ...
  async softDelete(id: number): Promise<Interview | null> {
    try {
      const existingDocument = await this.model.findByPk(id);
